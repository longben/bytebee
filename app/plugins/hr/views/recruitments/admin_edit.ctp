...
<?php echo $form->create('Recruitment', array('id' => 'bbForm', 'name' => 'Recruitment'));?>
	...
	<?php
		...
		echo $form->hidden('old_city', array('value' => $this->data['Recruitment']['region_id']));
		echo $form->input('number', array('label' => '招聘人数', 'class' => 'required alphanumeric',  'title' =>__('请输入招聘人数', true)));
		...
		echo $form->input('email', array('class' => 'required email', 'title' =>__('请输入正确格式的电子邮箱', true)));		
