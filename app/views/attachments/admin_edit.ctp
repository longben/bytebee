<?php echo $this->Html->script(array('swfupload/swfupload', 'swfupload/plugins/swfupload.swfobject', 'swfupload/implement/forms/fileprogress', 'swfupload/implement/forms/handlers3'), false); ?>
...
<?php echo $this->Form->create('Attachment', array('id' => 'bbForm'));?>
	...
	?>
		<div class="input text">
		  <label for="DocumentDocument">供下载的文件</label>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('返回下载文件列表', true), $referer);?></li>
	</ul>
</div>