...
<body>
<?php echo $form->create('User', array('action' => 'login', 'onSubmit' => "return $.formValidator.pageIsValid(1)"));?>
...
<tr>
  ...
  <tr>
	...
	<tr>
	  <td>用户名：</td>
	  <td>
	    <?php echo $form->input('user_login', array('label' => '','style' => 'background:#E8FDFF;border:1px solid #85A0BD;width:178px;height:28px;padding-top:6px;font-weight:bold', "onFocus" => 'this.style.backgroundColor=\'#fff\'', 'onBlur' => 'this.style.backgroundColor=\'#E8FDFF\''));?>
	  </td>
	  <td></td>
	</tr>
	<tr>
	...
	<tr>
	  <td>密　码：</td>
	  <td>
	    <?php echo $form->password('user_pass', array('label' => '','style' => 'background:#E8FDFF;border:1px solid #85A0BD;width:178px;height:28px;padding-top:6px;font-weight:bold', 'onFocus' => 'this.style.backgroundColor=\'#fff\'', 'onBlur' => 'this.style.backgroundColor=\'#E8FDFF\''));?>
	  </td>
	  <td><!--&nbsp;忘记密码了？--></td>
	</tr>
	<tr>
	...
	<tr>
	  <td>验证码：</td>
	  <td>
	    <?php echo $form->input('captcha', array('label' => '', 'div' => false ,'style' => 'background:#E8FDFF;border:1px solid #85A0BD;width:100px;height:28px;padding-top:6px;font-weight:bold', 'onFocus' => 'this.style.backgroundColor="#fff"', 'onBlur' => 'this.style.backgroundColor="#E8FDFF"', 'maxlength' => 4));?>
	    <a href="/login" title="看不清楚吗？请点击更换验证图片"><img src="<?php echo $html->url('/users/captcha'); ?>" align="absmiddle" width="75px" height="38px" border="0" /></a>
	  </td>
	  <td align="left"></td>
	</tr>
	<tr>
	...
	<tr>
	  <td align=center style="color:#ff0000">
        <?php echo $session->flash(); echo $session->flash('auth');?>
	  </td>
	</tr>
	</table>
	</td>
